                            ...
                            <form action="/user/myUpdate?Redirect=/user/setting" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="mb-3">
										...
										<a href="/users/group/{{$data->class->id}}.html" target="_blank" class="tips--top" aria-label="{{$data->class->name}}" style="color:{{$data->class->color}}; ">{!! $data->class->icon !!} {{$data->class->name}}</a>
                                    </div>
                                    <div class="mb-3">
