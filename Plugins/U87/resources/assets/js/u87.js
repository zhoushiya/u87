...
"use strict";
/*!*****************************************************!*\
  !*** ./app/Plugins/U87/resources/package/js/u87.js ***!
  \*****************************************************/
  ...
  $('a[u87-click="like-topic"]').click(function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/topic/like.topic", {
      ...
      if (!data.success) {
        ...
        // 点赞成功!
        var likes_text = $(_this).find('span[u87-show="topic-likes"]');
        var y_likes = likes_text.text();
        y_likes = parseInt(y_likes);

        if (data.code === 200) {
          $(_this).find('span[u87-show="topic-likes"]').text(y_likes + 1);
          $(_this).find('svg').addClass('icon-filled text-red');
          $(_this).attr({
            'aria-label': '取消点赞'
          });
          ...
          $(_this).find('span[u87-show="topic-likes"]').text(y_likes - 1);
          $(_this).find('svg').removeClass('icon-filled text-red');
          $(_this).attr({
            'aria-label': '点赞'
          });
  ...
  $('a[u87-click="star-topic"]').click(function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/topic/star.topic", {
      ...
      if (!data.success) {
        ...
        var stars_text = $(_this2).find('span[u87-show="topic-stars"]');
        var y_stars = stars_text.text();
        y_stars = parseInt(y_stars);

        if (data.code === 200) {
          $(_this2).find('span[u87-show="topic-stars"]').text(y_stars + 1);
          $(_this2).find('svg').addClass('icon-filled text-blue');
          $(_this2).attr({
            'aria-label': '取消收藏'
          });
          izitoast__WEBPACK_IMPORTED_MODULE_1___default().success({
          ...
          $(_this2).find('span[u87-show="topic-stars"]').text(y_stars - 1);
          $(_this2).find('svg').removeClass('icon-filled text-blue');
          $(_this2).attr({
            'aria-label': '收藏'
          });
          izitoast__WEBPACK_IMPORTED_MODULE_1___default().info({
  ...
  $('a[u87-click="comment-like-topic"]').click(function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/comment/like.topic.comment", {
      ...
      if (!data.success) {
        ...
        var likes_text = $(_this3).find('span[u87-show="comment-topic-likes"]');
        var y_likes = likes_text.text();
        y_likes = parseInt(y_likes);

        if (data.code === 200) {
          $(_this3).find('span[u87-show="comment-topic-likes"]').text(y_likes + 1);
          $(_this3).find('svg').addClass('icon-filled text-red');
          $(_this3).attr({
            'aria-label': '取消点赞'
          });
          izitoast__WEBPACK_IMPORTED_MODULE_1___default().success({
          ...
          $(_this3).find('span[u87-show="comment-topic-likes"]').text(y_likes - 1);
          $(_this3).find('svg').removeClass('icon-filled text-red');
          $(_this3).attr({
            'aria-label': '点赞'
          });
          izitoast__WEBPACK_IMPORTED_MODULE_1___default().info({
  ...
  $('a[u87-click="star-comment"]').click(function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/comment/star.comment", {
      ...
      if (!data.success) {
        ...
        var stars_text = $(_this4).find('span[u87-show="comment-stars"]');
        var y_stars = stars_text.text();
        y_stars = parseInt(y_stars);

        if (data.code === 200) {
          $(_this4).find('span[u87-show="comment-stars"]').text(y_stars + 1);
          $(_this4).find('svg').addClass('icon-filled text-blue');
          $(_this4).attr({
            'aria-label': '取消收藏'
          });
          izitoast__WEBPACK_IMPORTED_MODULE_1___default().success({
          ...
          $(_this4).find('span[u87-show="comment-stars"]').text(y_stars - 1);
          $(_this4).find('svg').removeClass('icon-filled text-blue');
          $(_this4).attr({
            'aria-label': '收藏'
          });
          izitoast__WEBPACK_IMPORTED_MODULE_1___default().info({
